  ...
  static ThemeData themeData = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      titleMedium: TextStyle(
          ...
          fontSize: 25,
          fontWeight: FontWeight.w400),
           displayLarge: TextStyle(color: onPrimaryLight, fontSize: 25, fontWeight: FontWeight.w400),
    displayMedium: TextStyle(color: primaryLight, fontSize: 25, fontWeight: FontWeight.w400),
    displaySmall: TextStyle(color: onSecondaryLight, fontSize: 25, fontWeight: FontWeight.w400),
    labelSmall: TextStyle( color: onSecondaryLight,
          fontSize: 20,
          fontWeight: FontWeight.w400)
    ),
